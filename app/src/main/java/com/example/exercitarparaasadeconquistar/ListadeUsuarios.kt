...
class ListadeUsuarios : AppCompatActivity() {
    private lateinit var empRecyclerView: RecyclerView
    private lateinit var tvLoadingData: TextView
    private lateinit var empList: ArrayList<CadastroUsuario>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        empList = arrayListOf<CadastroUsuario>()
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    for (empSnap in snapshot.children){
                        val empData = empSnap.getValue(CadastroUsuario::class.java)
                        empList.add(empData!!)
                    }
                    val mAdapter = ListAdapter(empList)
